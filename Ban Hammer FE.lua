...
function CreatePart(FORMFACTOR, PARENT, MATERIAL, REFLECTANCE, TRANSPARENCY, BRICKCOLOR, NAME, SIZE, ANCHOR)
	...
	NEWPART.Parent = PARENT
		...
		if success then
			...
			local d = Instance.new("SpawnPoint", game.ReplicatedStorage)
			return d
		end
	end
end
	...
	for i,v in ipairs(CHARACTER:GetChildren()) do
		if v.ClassName == "Part" or v.ClassName == "MeshPart" then
			if v.Name ~= "HumanoidRootPart" then
				...
				if not success then
					BOD = Instance.new("SpawnLocation", game.ReplicatedStorage)
				end
...
function BANSLAM()
	...
	repeat
		...
		CreateSound("147722910", owner.Character, 10, 1)
		BANNEAREST(RootPart.CFrame*CF(0,0,-6).p,25)
		if HITFLOOR ~= nil then
			CreateSound("289842971", owner.Character, 10, 1)
			CreateSound("289842971", owner.Character, 10, 1)
			CreateSound("289842971", owner.Character, 10, 1)
			CreateSound("289842971", owner.Character, 10, 1)
