...
FE Compatibility by JhonXD2006 :P
]]

script.Parent = owner.Character

local function rand()
	return 56-- math.random(-100, 100)
end
...
local gan = Instance.new("Part", char)
gan.Size = Vector3.new(1, 1, 1)
gan.Anchored = false
gan.CFrame = CFrame.new(0, 10, 0)
gan.BrickColor = BrickColor.new("Black")
gan:BreakJoints()
local gunMesh = Instance.new("SpecialMesh", gan)
gunMesh.MeshId = "rbxassetid://430697201"
gunMesh.Scale = Vector3.new(1, 1, 1)

local gunWeld = Instance.new("Weld", gan)
...
LH.C0 = lhc0
RH.C0 = rhc0
elseif action == "kook" then
NK.C0 = nkc0 * CFrame.new(rand2()/10, rand2()/10, rand2()/10)
TS.C0 = tsc0 * CFrame.new(math.random(-10, 10)/10, rand2()/10, rand2()/10)
LS.C0 = lsc0 * CFrame.new(math.random(-10, 10)/10, rand2()/10, rand2()/10)
LH.C0 = lhc0 * CFrame.new(math.random(-10, 10)/10, rand2()/10, rand2()/10)
RS.C0 = rsc0 * CFrame.new(math.random(-10, 10)/10, rand2()/10, rand2()/10)
RH.C0 = rhc0 * CFrame.new(math.random(-10, 10)/10, rand2()/10, rand2()/10)
...
local appc = Instance.new("Part", char)
appc.CFrame = char.HumanoidRootPart.CFrame * CFrame.new(0, -1, 0)
appc.Anchored = true
appc.CanCollide = true
appc.Size = Vector3.new(8, 4, 1)
appc:BreakJoints()
local caactext = Instance.new("SurfaceGui", appc)
...
local boom = Instance.new("Explosion", char)
boom.BlastRadius = 1
boom.BlastPressure = 9000
